...
useEffect(() => {
  ...
  useEffect(() => {
    const getSubContent = async () => {
      try {
        const res = await api.get("/content/getLatestNews");
    ...
    getSubContent();
  }, []); // Dependency array is empty because `id` is a constant.

  const getBanners = () => {
    // First API call to get banners
    api.get("/content/getLatestNews")
      .then((res) => {
      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-12 text-center">
            ...
            <h2 className="blog-title">Latest EmsMedia News</h2>
        ...
        <div className="col-xxl-9 col-lg-10">
            <div className="th-blog blog-single">
              <div className="blog-content-wrap">
                ...
                <Link to= {`${item.internal_link}/${item.content_id}`} data-theme-color="#6234AC" className="category">
              {item.title}
            </Link>
                </div>
              </div>
